...
export type TrpcClient = {
  ...
  flight: {
    ...
    upcoming: {
      query: (input: { scope: import('./router').UpcomingScope }) => Promise<
        import('./router').Flight[]
      >;
    };
    create: {
  ...
  flightTrack: {
    ...
    get: { query: (id: number) => Promise<import('./router').FlightTrackRow | null> };
  };
  airport: {
    get: { query: (id: number) => Promise<import('./router').Airport | null> };
    getFromIcao: { query: (icao: string) => Promise<import('./router').Airport | null> };
    getFromIata: { query: (iata: string) => Promise<import('./router').Airport | null> };
  };
  aircraft: {
    get: { query: (id: number) => Promise<import('./router').Aircraft | null> };
    getByIcao: { query: (icao: string) => Promise<import('./router').Aircraft | null> };
    getByName: { query: (name: string) => Promise<import('./router').Aircraft | null> };
    list: { query: () => Promise<import('./router').Aircraft[]> };
  };
  airline: {
    get: { query: (id: number) => Promise<import('./router').Airline | null> };
    getByIcao: { query: (icao: string) => Promise<import('./router').Airline | null> };
    getByIata: { query: (iata: string) => Promise<import('./router').Airline | null> };
    getByName: { query: (name: string) => Promise<import('./router').Airline | null> };
  ...
  share: {
    ...
    create: {
      mutate: (input: import('./router').ShareCreateInput) => Promise<
        import('./router').PublicShare
      >;
    };
    update: {
      mutate: (input: import('./router').ShareUpdateInput) => Promise<
        import('./router').PublicShare
      >;
    };
  ...
  weather: {
    getMetar: { query: (icao: string) => Promise<unknown> };
  };
};
